...
class Main(Gtk.Window):
    def __init__(self):
        ...
        self.set_icon_from_file(os.path.join(
            GUI.base_dir, 'images/snigdhaos.png'))
    ...
    def on_launch_clicked(self, widget, event, link):
        if os.path.isfile("/usr/bin/archlinux-tweak-tool"):
            ...
            md.format_secondary_markup(
                "<b>Arch Linux Tweak Tool</b> was not found on your system\n\
Do you want to install it?")
    ...
    def mirror_update(self):
        GLib.idle_add(self.cc.set_markup, "<span foreground='teal'><b>Updating Arch Mirrorlist Using Rate-Mirrors!</b> \nIt will take some time, Please Wait...</span>")  # noqa
        GLib.idle_add(self.button8.set_sensitive, False)
        ...
        GLib.idle_add(self.cc.set_markup, "<span foreground='orange'><b>Updating BlackArch Mirrorlist Using Rate-Mirrors</b> \nThis may take some time, please wait..</span>")  # noqa
        ...
        GLib.idle_add(self.cc.set_markup, "<span foreground='orange'><b>Updating Chaotic AUR Mirrorlist Using Rate-Mirrors</b> \nThis may take some time, please wait...</span>")  # noqa
        ...
        GLib.idle_add(self.cc.set_markup, "<span foreground='orange'><b>Synchronizing...</b></span>")  # noqa
    ...
    def installATT(self):
        ...
        GLib.idle_add(self.MessageBox,
                      "Success!",
                      "<b>Arch Linux Tweak Tool</b> has been installed successfully")  # noqa
